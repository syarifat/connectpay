...
<div class="container py-4">
    <div class="row">
        <div class="col-md-12 mb-4">
            <h4 class="fw-bold text-dark">Selamat Datang, {{ $customer->nama }}!</h4>
            <p class="text-muted">
                ID Pelanggan: 
                <span class="badge bg-info-subtle text-info px-3">{{ $customer->id_pelanggan }}</span>
            </p>
        </div>

        <div class="col-md-4 mb-4">
            <div class="card border-0 shadow-sm p-4 text-center bg-white border-bottom border-4 {{ $isLunas ? 'border-success' : 'border-danger' }}" style="border-radius: 15px;">
                ...
                @if($isLunas)
                    ...
                    <p class="small text-secondary mb-0">
                        Terima kasih! Layanan Anda aktif hingga <strong>{{ $endActive->translatedFormat('d F Y') }}</strong>.
                    </p>
                @else
                    <div class="py-2">
                    ...
                    <hr>
                    <p class="small text-secondary mb-0">
                        Segera lakukan pembayaran untuk memperpanjang masa aktif hingga <strong>{{ $endActive->translatedFormat('d F Y') }}</strong>.
                    </p>
                @endif
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="fw-bold text-dark">{{ $h->bulan }} {{ $h->tahun }}</td>
                            ...
                            <tr>
                                <td colspan="5" class="text-center text-muted py-5">
                                    ...
                                    Belum ada riwayat pembayaran tersedia.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
